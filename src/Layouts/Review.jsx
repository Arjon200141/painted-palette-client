...
const Review = ({ review }) => {
    ...
    return (
        <div ref={ref} className={`animate__animated ${isVisible ? 'animate__fadeInDown' : ''} animate__delay-1s animate__duration-2s text-lg border-2 shadow-xl rounded-xl bg-lime-50 p-6`}>
