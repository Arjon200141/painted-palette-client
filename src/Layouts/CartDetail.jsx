...
const CartDetail = ({ card }) => {
    ...
    return (
        <div className='my-12 md:mx-8'>
            <div className="hero h-auto bg-base-100 shadow-2xl text-lg rounded-xl">
                    ...
                    <div>
                        ...
                        <Link to={`/cards/${card.id}`}>
                            <div className="card-actions justify-start mt-4">
                                <button className="btn px-8 sm:w-full md:w-3/4 bg-red-200 text-lg font-medium">View Details</button>
                            </div>
                        </Link>
                    </div>
                </div>
